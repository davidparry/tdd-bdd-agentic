...
/**
 * Runs the client's own Gherkin feature file through Cucumber on the JUnit
 * Platform. Surefire executes this suite alongside the JUnit unit tests, so
 * {@code mvn test -pl mcp-client} reports one combined result — the same
 * one-bar discipline the workshop teaches.
 */
@Suite
@IncludeEngines("cucumber")
@SelectClasspathResource("features")
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.davidparry.workshop.mcp.client")
