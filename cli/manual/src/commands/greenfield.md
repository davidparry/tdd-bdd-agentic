...
Splitting the description into requirements with qwen3:8b - working ...
...
```text
Asking qwen3:8b to address finding 1 of 1 - working ...
...
- An LLM is optional: with no reachable Ollama model the generation
  steps fall back to deterministic templates you edit yourself.
